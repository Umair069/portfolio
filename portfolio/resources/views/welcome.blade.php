 ...
 */
        ...
        {var a=e(this.hash);
            if((a=a.length?a:e("[name="+this.hash.slice(1)+"]")).length)
                return e("html, body").animate({scrollTop:a.offset().top-72},1e3,"easeInOutExpo"),!1}})
            ,e(".js-scroll-trigger").click(function(){e(".navbar-collapse").collapse("hide")}),e("body")
            .scrollspy({target:"#mainNav",offset:75});function a(){100<e("#mainNav").offset().top?e("#mainNav")
            .addClass("navbar-scrolled"):e("#mainNav").removeClass("navbar-scrolled")}a(),e(window).scroll(a),
            e("#portfolio").magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:
                    {enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.'}})}(jQuery);
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Umair Ansar</a>
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                <h1 class="text-uppercase text-white font-weight-bold">MY First Portfolio</h1>
                <hr class="divider my-4">
            </div>
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 font-weight-light mb-5">Starting with simple coding using bootstrap</p>
                <a class="btn btn-primary btn-xl js-scroll-trigger" href="#portfolio">Check my gallery</a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <p class="text-white-50 mb-4">I have acknowledge in java and c++ and also have knowledge in html and css </p>
                <!--  <a class="btn btn-light btn-xl js-scroll-trigger" href="#servic">Get Started!</a>-->
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\01.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\01.jpeg" alt="">
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\02.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\02.jpeg" alt="">
                    <div class="portfolio-box-caption">
                        <div class="project-category text-white-50">
                            Check
                        </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\03.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\03.jpeg" alt="">
                    <div class="portfolio-box-caption">
                        <div class="project-category text-white-50">
                            Check
                        </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\04.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\04.jpeg" alt="">
                    <div class="portfolio-box-caption">
                        <div class="project-category text-white-50">
                            Category
                        </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\05.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\05.jpeg" alt="">
                    <div class="portfolio-box-caption">
                        <div class="project-category text-white-50">
                            Check
                        </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\06.jpeg">
                    <img class="img-fluid" src="C:\Users\hp\Downloads\Compressed\startbootstrap-creative-gh-pages\img\portfolio\fullsize\06.jpeg" alt="">
...
<section class="page-section" id="contact">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="mt-0">Keep In Touch Always!</h2>
                <hr class="divider my-4">
                <p class="text-muted mb-5">If you have any queries contact us or email </p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                <i class="fas fa-phone fa-3x mb-3 text-muted"></i>
                <div>0332 5556630</div>
            </div>
            <div class="col-lg-4 mr-auto text-center">
                <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                <!-- Make sure to change the email address in anchor text AND the link below! -->
                <a class="d-block" href="mailto:contact@yourwebsite.com">contact@mywebsite.com</a>
            </div>
        </div>
    </div>
</section>
...
<footer class="bg-light py-5">
    <div class="container">
        <div class="small text-center text-muted">Portfolio page</div>
    </div>
</footer>
